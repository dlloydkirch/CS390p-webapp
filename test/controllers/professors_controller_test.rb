...
class ProfessorsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create professor" do
    assert_difference('Professor.count') do
      post professors_url, params: { professor: { department: @professor.department, email: @professor.email, id_number: @professor.id_number, name: @professor.name, office: @professor.office, phone: @professor.phone } }
    end
  ...
  test "should update professor" do
    patch professor_url(@professor), params: { professor: { department: @professor.department, email: @professor.email, id_number: @professor.id_number, name: @professor.name, office: @professor.office, phone: @professor.phone } }
